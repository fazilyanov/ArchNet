...
$.extend($.jgrid,{
	defaults : {
	  ...
	  emptyrecords: "Нет записей",
		loadtext: '',//'Загрузка..',//'<div class="progress progress-striped active" style="margin-bottom: 0px"><div class="progress-bar"  role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%"><span class="sr-only">100% Complete</span></div></div>',
		pgtext : "Стр. {0} из {1}"
	},
	search : {
    caption: "Поиск...",
