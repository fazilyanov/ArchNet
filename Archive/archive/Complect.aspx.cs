    ...
    {      public faList list;
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            //{
                ...
                list.BaseName = "zao_stg";// Master.cur_basename != "" ? Master.cur_basename : "";
                list.ShowFilterPanel = true;
                list.EditFormWidth = 1000;
                list.EditFormHeight = 200;

                // Шапка
                cur = new faCursor("_complect_view");
                ...
                if (Request.QueryString["id"] != null || Request.QueryString["act"] != null)
                {
                    ...
                    {
                        cur = new faCursor("_complect_list_view");
                        cur.TableID = 23;
                        cur.Caption = "Документы"; 
                        cur.EnableViewButton = true; cur.EnableFileButton = true;
                        cur.EnableAddButton = cur.EnableEditButton = cur.EnableDelButton = false;
                        cur.EnableSaveButton = true;//Session[Master.cur_basename + "_access_complect_edit"] != null;// Session[Master.cur_basename + "_access_docversion_edit"] != null;
                        cur.ShowPager = false;
                        // Поля
                        // ID
                        fld = new faField();
