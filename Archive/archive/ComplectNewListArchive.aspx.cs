...
{
    public partial class ComplectNewListArchive : System.Web.UI.Page
    {
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            list.RouteName = "complectnewlistarchive";
            ...
            // Шапка
            cur = new faCursor("_complectnew_view_archive");
            cur.TableID = 0;
            cur.Caption = "Архив / Спецификации комплектов (полный)";
            ...
            //cur.EnableCSVButton = true;cur.EnableExcelButton = // Убрано, потому что выборка из вьюшки в которой соединяются все базы не справляется 
