<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LetGetCardsAltHelp1.aspx.cs" Inherits="WebArchiveR6.LetGetCardsAltHelp1" %>
    ...
    <form id="form1" runat="server">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <br />
                <a class="thumbnail" href="/site/img/LetGetCardsAlt_1_1.png" target="_blank">
                    <img src="/site/img/LetGetCardsAlt_1_1.png" alt="">
                </a>
                ...
                <p style="text-indent: 25px;">
                   На рисунке 1 отображена структура подчиненности документов. Кликнув в панели навигации раздела «Структура» по кнопке «Показать полную структуру договора», можно увидеть все документы, относящиеся к договору, на основании которого была сформирована спецификация и бухгалтерские документы (рисунок 2).  
                </p>
                <br />
                <a class="thumbnail" href="/site/img/LetGetCardsAlt_1_2.png" target="_blank">
                    <img src="/site/img/LetGetCardsAlt_1_2.png" alt="">
                </a>
                <p style="text-align: center;">рисунок 2</p>
                <br />

                <p style="text-indent: 25px;">
                    Кнопка «Скрыть бухгалтерские документы» позволяет показать в структуре только договор и все его приложения, в том числе спецификации, дополнительные соглашения и т.д. (рисунок 3).
                </p>
                <br />
                <a class="thumbnail" href="/site/img/LetGetCardsAlt_1_3.png" target="_blank">
                    <img src="/site/img/LetGetCardsAlt_1_3.png" alt="">
                </a>
