...
{
    public partial class InsertFromScanerRepair : System.Web.UI.Page
    {
        ...
        protected override void OnInit(EventArgs e) {
           ...
           // cur = "test_complectnew_list_cursor_" + id;
            sc = (Session["_complect_repair_list_cursor_sidx"] ?? "").ToString();
            sd = (Session["_complect_repair_list_cursor_sord"] ?? "").ToString();
            string buf;
            Response.Clear();
